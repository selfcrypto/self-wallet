<template>
  <div>
    ...
    <div class="settings__label">
      <p>
        Pause SelfCrypto interactions with Ethereum DApps if you are using other
        web3 extensions
      </p>
    </div>
    ...
    /> -->
    <!-- <div class="settings__label">
      <p>Enable SelfCrypto act like Unisat wallet for dapps</p>
    </div> -->
    ...
    <!-- <div class="settings__label">
      <p>
        MEW uses Amplitude events to improve SelfCrypto. No identifiable
    ...
    <!-- <div class="settings__label">
      <p>Set the idle time in minutes before SelfCrypto will become locked.</p>
    </div> -->
  </div>
</template>
