...
<template>
  ...
  >
    ...
    <ellipse
      ...
      style="
        animation: 0.566s linear both spin_t_ca, 0.566s linear both spin_o_ca,
          0.566s linear both spin_da_ca, 0.566s linear both spin_do_ca;
      "
    />
    <path
      id="check"
      ...
      style="
        animation: 0.566s linear both check_o_ca, 0.566s linear both check_da_ca;
      "
    />
  </svg>
</template>
